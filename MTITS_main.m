...
load measurments.mat;                                   %Load measurements data


det = find(any(gemeten_flow,2))';                       %location of the detectors
dt = 5/60;                                              %simulation interval
totT = round(3/dt);                                     %simulation time horizon
paper_experiment_part = 'A';                            % The section corresponds in the paper {A, B}
